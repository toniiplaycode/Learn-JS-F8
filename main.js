...
// a[0] = 5;
// console.log(a, b);
// // tham chiếu của biến object hoặc mảng được gán 1 giá trị mới thì biến được gán sẽ không thay đổi giá trị vì biến được gán đã trỏ tới 1 địa chỉ value mới, còn biến gán thì vẫn trỏ tới địa chỉ cũ
// var a = [1, 2, 3, 4]
// var b = a;
// a = [4, 5, 6];
// console.log(a, b);
